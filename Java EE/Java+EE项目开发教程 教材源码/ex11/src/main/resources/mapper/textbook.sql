...
insert into user(login_name,password,user_name,mobile) values('slin', '888888', '林卫海', '13568975426');
...
(
	distribute_book_id int primary key auto_increment,
	book_id int,
	user_id int,
...
set names gbk;
insert into distribute_book(book_id,user_id,distribute_date,distribute_count) values(1,1,'2022-07-28',51);
insert into distribute_book(book_id,user_id,distribute_date,distribute_count) values(2,1,'2022-07-28',38);
insert into distribute_book(book_id,user_id,distribute_date,distribute_count) values(3,2,'2022-06-26',2);

-- 教材申请及审批
create table apply_book	 
(
                 apply_book_id int primary key auto_increment,
	book_id int,
	user_id int,
